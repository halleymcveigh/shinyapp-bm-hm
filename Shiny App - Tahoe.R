                ...
                navbarPage(
                  ...
                  tabPanel("References",
                           mainPanel(h3("References"),
                                     ...
                                     br(),
                                     p("URban Biodiversity and Ecosystem Services. 2015. Accessed: ![https://www.iucn.org/downloads/urbes_factsheet_08_web_1.pdf](https://www.iucn.org/downloads/urbes_factsheet_08_web_1.pdf)."),
                                     br(),
