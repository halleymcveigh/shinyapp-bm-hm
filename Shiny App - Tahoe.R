...
# Tab 2: Ecosystem Service Overview
  output$intro_reactive <- reactive({case_when(
    input$ecosystem_services_checkbox == "Water" ~ "Water quantity and water quality are important ecosystem benefits not only to stakeholders within the TCSI, but users downstreams and the environment. Water plays a critical role in providing needed habitat for aquatic species. Photo Credit: Larry Miller, CC BY-SA 2.0 <https://www.flickr.com/photos/46126272@N00/8613413029/>.",
